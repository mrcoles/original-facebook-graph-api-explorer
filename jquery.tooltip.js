...
;(function($) {
	...
	function update(event)	{
		...
		if (event) {
            ...
            bottom = settings(current).bottom;
            if (typeof bottom !='undefined') { //HACK - support bottom positioning!
                top = event.pageY + settings(current).bottom - $(helper.parent[0]).height() - 15;
            }
			var right='auto';
